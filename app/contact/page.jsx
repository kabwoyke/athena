                                ...
                                <ul class="mb-6 md:mb-0">
                                    ...
                                    <li class="flex">
                                        ...
                                        <div class="ml-4 mb-4">
                                            ...
                                            <p class="text-gray-600 dark:text-slate-400">Mobile: 073453034034</p>
                                            <p class="text-gray-600 dark:text-slate-400">Mail: athenalink@gmail.com</p>
                                        </div>
                                    </li>
                                    <li class="flex">
                                        <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                        ...
                                        <div class="ml-4 mb-4">
                                            <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                                hours</h3>
                                            <p class="text-gray-600 dark:text-slate-400">Monday - Monday</p>
